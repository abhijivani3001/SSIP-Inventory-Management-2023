  ...
  return (
    <div className={`${isOpen ? "block" : "hidden"} fixed inset-0 flex items-center justify-center z-50`}>
      <div className="bg-white w-96 p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold text-black mb-4 min-w-0 flex items-center justify-center"> Login
        </h2>
        <form onSubmit={handleLogin}>
          ...
          <div className="text-center">
            <button
              type="submit"
              className="text-gray-700 hover:bg-gray-200 text-white py-2 px-4 rounded-lg"
            >
              Login
            </button>
          </div>
